...
| Ângulo | Pergunta possível do aluno | Prova que pode responder |
|---|---|---|
| Começar | “Por onde começo para este concurso?” | Próxima missão real do plano da edição correta. |
| Clareza | “O que faço hoje?” | Disciplina, assunto e ação de uma missão em zoom. |
| Material | “Onde encontro a aula?” | Leitor de teoria/resumo aberto a partir da missão. |
| Lei | “Que trecho da lei devo ler?” | Norma e leitura indicadas na missão, conferidas. |
| Prática | “Como testo o assunto?” | Entrada real para questões e filtro por disciplina/assunto. |
...
Antes de destacar uma funcionalidade, pergunte “por que isso importa para este aluno?” até chegar a uma consequência operacional ou emocional plausível. Exemplo: `missões divididas por assunto → próxima tarefa identificável → menos necessidade de reorganizar o estudo a cada sessão`; `check real → ponto de retomada visível → voltar sem procurar onde parou`. Confirme o comportamento na edição; não converta benefício operacional em promessa de aprovação ou economia de tempo quantificada sem dados.

A tensão pode ser alívio, clareza, controle, curiosidade ou frustração reconhecível. Ela abre atenção; mecanismo e prova sustentam a decisão. Não dramatize falta de tempo, atraso ou medo da reprovação para fabricar urgência.

## CTA proporcional à consciência

- **Direto:** adquirir, assinar ou entrar — quando oferta, destino e condições estiverem confirmados e o público já compreender o produto.
- **De transição:** pedir amostra, ver uma missão, solicitar detalhes ou comentar uma palavra — quando a peça precisa reduzir dúvida e a entrega prometida realmente existe.

Escolha uma ação principal. Um comentário não obriga compra; uma amostra não cria dívida moral. Não use CTA de conversão por hábito numa peça cuja única função é demonstrar ou esclarecer uma objeção.

## Ajustes de linguagem e hierarquia
